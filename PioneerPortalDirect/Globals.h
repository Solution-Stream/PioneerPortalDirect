...
@property NSInteger numberQuoteVehicles;
@property NSInteger numberQuoteDrivers;
@property NSInteger numQuoteVehiclesLoaded;
@property NSInteger numQuoteDriversLoaded;
